...
6. oh-my-zsh  설치하기
   ...
   > **팁:** 터미널에서 **ls** 명령을 실행할 때 디렉토리명이 초록색 배경에 파란색으로 보여 식별이 잘 되지 않는 문제점이 있다. 이럴 때는 [How to setup a nice looking terminal with WSL in Windows 10 Creators Update](https://medium.com/@Andreas_cmj/how-to-setup-a-nice-looking-terminal-with-wsl-in-windows-10-creators-update-2b468ed7c326) 글을 참고하면 도움이 될 것이다. 
